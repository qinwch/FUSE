...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--train_dir", required=True, help="Directory containing settings.yaml and training outputs."
    )
    parser.add_argument(
        "--dataset_dir",
        default=None,
        help="Optional directory containing x.npy/theta.npy or where generated data should be saved.",
    )
    ...
    if dataset_files_exist(dataset_dir):
        dataset = load_dataset(directory_save=dataset_dir, settings=settings)
    elif args.generation_batch_size is None:
